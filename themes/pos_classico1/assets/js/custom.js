		...
		if ($(window).width() >= 768){
			$(window).scroll(function() {    
			  ...
			  if (scroll < scroll_height) {
			   $(".menu-warrper").removeClass("scroll-menu animated fadeInDown");
			  }else{
			   $(".menu-warrper").addClass("scroll-menu animated fadeInDown");
			  }
			});
		}
	}
...
function accordionFooter(status)
{
	if(status == 'enable')
	{
		$('#footer .footer_block .pos-title').on('click', function(e){
	...
	{
		$('.footer_block .pos-title').removeClass('active').off().parent().find('.toggle-footer').removeAttr('style').slideDown('fast');
...
function display(view)
{
	if (view == 'list')
	{
		...
		$('.product_content .item-product').removeClass('col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-3').addClass('col-xs-12');
		$('.product_content .item-product').each(function(index, element) {
			...
			html += '<h4 itemprop="name" class="product_name">'+ $(element).find('.product_name').html() + '</h4>';
	...
	else
	{
		...
		$('.product_content .item-product').removeClass('col-xs-12').addClass('col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-3');
		$('.product_content .item-product').each(function(index, element) {
			var html = '';
			var id_product = $('article.js-product-miniature').attr('data-id-product');
			var id_product_attr = $('article.js-product-miniature').attr('data-id-product-attribute');
